...
var YCArtworkViewEditor = {
    ...
    createEditor : function (args) {
        ...
        element.className = "YCArtworkViewEditor";

        section = CBUI.createSection();

        var imageChosenCallback = YCArtworkViewEditor.handleImageChosen.bind(undefined, {
            spec : args.spec,
            specChangedCallback : args.specChangedCallback,
        });
        var imageRemovedCallback = YCArtworkViewEditor.handleImageRemoved.bind(undefined, {
            spec : args.spec,
            specChangedCallback : args.specChangedCallback,
        });
        ...
        if (args.spec.image) {
            chooser.setImageURLCallback(YCArtworkViewEditor.imageToURL(args.spec.image));
        }
    ...
    handleImageChosen : function (args, chooserArgs) {
        ...
        xhr.onload = YCArtworkViewEditor.handleImageChosenDidLoad.bind(undefined, {
    ...
    handleImageChosenDidLoad : function (args) {
        ...
        if (response.wasSuccessful) {
            ...
            args.setImageURLCallback(YCArtworkViewEditor.imageToURL(args.spec.image));
        } else {
